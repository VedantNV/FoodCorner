              ...
              <Col sm>
                ...
                <div className="text-header">
                  <Card style={{ width: "12rem", height: "12rem", color: "black", background: "lightBlue" }}>
                    ...
                    {/* <Card.Img variant="top" src="holder.js/100px180" /> */}
                    <Card.Body>
                      <Card.Title>Sushil Kumar Joshi</Card.Title>
                      <Card.Text>
              ...
              <Col sm>
                ...
                <div className="text-header">
                  <Card style={{ width: "12rem", height: "12rem", color: "black", background: "lightBlue" }}>
                    ...
                    {/* <Card.Img variant="top" src="holder.js/100px180" /> */}
                    <Card.Body>
                      <Card.Title>Tejas Sali</Card.Title>
                      <Card.Text>
            ...
            <Row>
              <Col sm>
                ...
                <div className="text-header">
                  <Card style={{ width: "12rem", height: "12rem", color: "black", background: "lightBlue" }}>
                    ...
                    {/* <Card.Img variant="top" src="holder.js/100px180" /> */}
                    <Card.Body>
                      <Card.Title>Vaidya Vedant Nitin</Card.Title>
                      <Card.Text>
              ...
              <Col sm>
                <div className="text-header" >
                  <Card style={{ width: "12rem", height: "12rem", color: "black", background: "lightBlue" }}>
                    ...
                    {/* <Card.Img variant="top" src="holder.js/100px180" /> */}
                    <Card.Body>
                      <Card.Title>Rohit Dhanraj</Card.Title>
                      <Card.Text>
              ...
              <Col sm> <div className="text-header">
                <Card style={{ width: "12rem", height: "12rem", color: "black", background: "lightBlue" }}>
                  ...
                  {/* <Card.Img variant="top" src="holder.js/100px180" /> */}
                  <Card.Body>
                    <Card.Title>Harshit Modi</Card.Title>
                    <Card.Text>
